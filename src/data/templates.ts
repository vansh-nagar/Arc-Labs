export const templates = [
  ...
  <div style="text-align:center;margin-bottom:1rem;">
    ...
    <div style="font-size:13px;color:#333;margin-top:0.25rem;">
      ...
      <span style="margin-right:0.5rem;">🔗 username</span>
      <span style="margin-right:0.5rem;">🌐 mysite.com</span>
      <span style="margin-right:0.5rem;">✉️ email@mysite.com</span>
      <span style="margin-right:0.5rem;">📞 +00.00.000.000</span>
    </div>
  </div>
  ...
  <div style="margin-bottom:1rem;">
    ...
    <div style="display:flex;justify-content:space-between;margin-bottom:0.25rem;">
      <span>2023 - 2027 Bachelor’s Degree at <strong>College</strong></span>
      <span>(GPA: 4.0/4.0)</span>
    </div>
    <div style="display:flex;justify-content:space-between;margin-bottom:0.25rem;">
  ...
  <div style="margin-bottom:1rem;">
    ...
    <p style="margin:0 0 0.5rem 0;">
      Last Name, First Name and First Name Other Last Name (Sept. 2019). “Paper: This is the name of the paper”. 
      In: <i>Some Journal</i> 99.18, pp. 2200–2300. url: 
      <a href="https://some-link.com" style="color:#00f;text-decoration:none;"> https://some-link.com</a>.
    </p>
    <p style="margin:0;">
      Last Name, First Name and First Name Again Last Name (Sept. 2022). “Paper II: This is another paper”. 
      In: <i>Some Journal</i> 99.18, pp. 2200–2300. url: 
  ...
  <div style="margin-bottom:1rem;">
    ...
    <div style="margin-bottom:0.75rem;">
      <div style="display:flex;justify-content:space-between;font-weight:600;">
        <span>Software Engineer, Apple – Cupertino, CA</span>
    ...
    <div>
      <div style="display:flex;justify-content:space-between;font-weight:600;">
        <span>Software Engineer Intern, Microsoft – Redmond, WA</span>
